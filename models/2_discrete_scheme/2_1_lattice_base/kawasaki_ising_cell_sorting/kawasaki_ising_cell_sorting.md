...
- Mochizuki, A., Iwasa, Y., & Takeda, Y. (1996). A stochastic model for cell sorting and measuring cell–cell adhesion. *Journal of Theoretical Biology*, 179(2), 129–146. <https://doi.org/10.1006/jtbi.1996.0054>
...
Kawasaki–Ising モデルは **離散・格子・確率平衡** の最小構成として、$q_{B/B}$ と IBC により **$A/m$ を実験パターンから推定** する枠組みを与える（J. Theor. Biol. 1996; Dev. Dyn. 1998 への応用）。
